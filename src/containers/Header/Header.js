...
class Header extends Component {
    ...
    componentDidMount() {
        ...
        if (userInfo && !_.isEmpty(userInfo)) {
            let role = userInfo.userData.user.roleId;
        ...
        // console.log('hoi dan it channel', this.props.userInfo)
    }
    render() {
        ...
        return (
            <div className="header-container">
                ...
                <div className='languages'>
                    <span className='welcome'><FormattedMessage id='homeheader.welcome' />, {userInfo && userInfo.userData.user.firstName ? userInfo.userData.user.firstName : "Admin"}!</span>
